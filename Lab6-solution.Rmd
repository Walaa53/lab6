...
row = 1643  , column = 6
the row it's about the resturant address (more information about it )
column ( address , city , state , zip , longitude , latitude)
...
the row it's about the hotels address (more information about it )
column ( address , city , state , zip , longitude , latitude)
...
the most = CA  and the fewest = DE

For Denny's - Most = CA

 La Quinta the most = TX  and the fewest = AG
